...
<h2>SQL - Запросы</h2>
<p style="font-size: 50px; width: 1000px;">1. Получить список всех устройств, находящихся в ремонте с данными заказчика.</p>
...
<p style="font-size: 50px; width: 1000px;">2. Получить список всех ремонтных заказов, выполненных определенным техником.</p>
...
<p style="font-size: 50px; width: 1000px;">3. Получить список всех устройств, у которых гарантия истекла.</p>
<p>0 результатов</p>
<?php
...
<p style="font-size: 50px; width: 1000px;">4. Получить список всех клиентов, у которых есть активные ремонтные заказы.</p>
<?php
...
<p style="font-size: 50px; width: 1000px;">5. Получить список всех устройств, которые были ремонтированы определенным техником.</p>
...
<p style="font-size: 50px; width: 1000px;">6. Получить список всех ремонтных заказов, у которых дата завершения ремонта попадает в заданный временной интервал.</p>
...
<p style="font-size: 50px; width: 1000px;">7. Получить список всех устройств, у которых неисправность связана с определенным компонентом.</p>
...
<p style="font-size: 50px; width: 1000px;">8. Получить список всех устройств, сгруппированных по типу и указанием общего количества устройств каждого типа.</p>
...
<p style="font-size: 50px; width: 1000px;">9. Получить список всех ремонтных заказов, сгруппированных по статусу и указанием количества заказов для каждого статуса.</p>
...
<p style="font-size: 50px; width: 1000px;">10. Получить список всех ремонтных заказов, у которых неисправность связана с определенным производителем устройства.</p>
